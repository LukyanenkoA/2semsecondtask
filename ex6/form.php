  ...
  <form action="index.php"
    ...
    />
      ...
      <select name="ability[]"
          ...
          <option value="2" <?php $values['2'] == 1 ? print 'selected' : '';?>>immortality</option>
          <option value="3" <?php $values['3'] == 1 ? print 'selected' : '';?>>invisibility</option>
          <option value="4" <?php $values['4'] == 1 ? print 'selected' : '';?>>levitation</option>
      </select>
      </label><br />
      <label>
      7. Your biography:<br />
